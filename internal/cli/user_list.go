...
func newUserListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "",
		Example: "  7geese-cli user list",
		Annotations: map[string]string{"pp:endpoint": "user.list", "pp:method": "GET", "pp:path": "/api/v1/user/", "mcp:read-only": "true"},
	...
	cmd.Flags().BoolVar(&flagIsActive, "is-active", false, "")
