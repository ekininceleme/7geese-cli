# 7Geese Printed CLI Agent Guide

This directory is a generated `7geese-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
7geese-pp-cli doctor --json
7geese-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
7geese-pp-cli which "<capability>" --json
7geese-pp-cli <command> --help
```
...
```bash
7geese-pp-cli <command> --help
7geese-pp-cli <command> --dry-run --agent
```
